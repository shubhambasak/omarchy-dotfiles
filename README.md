...
```
.config/
├── alacritty/, kitty/, ghostty/, foot/   # Terminal fonts (Adwaita Mono, size 15)
...
│   └── monitors.lua           # scale=1 (this panel isn't fractional-scale)
...
└── waybar/
    ...
    └── style.css              # Bar styling (20px Adwaita Mono)
...
| GTK scaling / Nautilus zoom | 1.5x / large | gsettings, set in `08-misc.sh` |
